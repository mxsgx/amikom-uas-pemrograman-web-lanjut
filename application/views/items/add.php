...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-cards">
			<div class="col-12">
				<form action="<?php echo base_url('items/add') ?>" method="post" class="card">
					<div class="card-body">
						<div class="row">
							...
							<div class="col-12 col-md-6 mb-3">
								...
								<input type="text"
									...
									value="<?php echo isset($old['sku']) ? $old['sku'] : '' ?>">
							...
							<div class="col-12 col-md-6 mb-3">
								...
								<input type="number"
									...
									value="<?php echo isset($old['stock']) ? $old['stock'] : '' ?>">
							...
							<div class="col-12 col-md-6 mb-3">
								...
								<input type="text"
									...
									value="<?php echo isset($old['unit']) ? $old['unit'] : 'pcs' ?>">
							...
							<div class="col-12 col-md-6 mb-3">
								...
								<input type="number"
									...
									value="<?php echo isset($old['buy_price']) ? $old['buy_price'] : '' ?>">
							...
							<div class="col-12 col-md-6 mb-3">
								...
								<input type="number"
									...
									min="0" value="<?php echo isset($old['sell_price']) ? $old['sell_price'] : '' ?>">
							...
							<div class="col-12 mb-3">
								...
								<textarea
									...
									placeholder="Input item description"><?php echo isset($old['description']) ? $old['description'] : '' ?></textarea>
